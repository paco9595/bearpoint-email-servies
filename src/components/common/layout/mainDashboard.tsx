    ...
    <div className="flex">
      <nav className="max-w-64 h-screen w-full border-r-2 border-r-border">
        ...
        <div className="px-6 py-5">
          ...
          <Link href={'/dashboard/projects'} className="text-sm">All Projects</Link>
        </div>
          ...
          <ul>
            {organizations?.map(({ id, name }) => (
              <li className={'my-2'} key={id}>
                <Link href={'/dashboard/projects'} className="text-sm" >{name}</Link>
              </li>
            ))}
          </ul>
        </div>
        <div className="px-6 py-5 border-b border-b-border">
          ...
          <ul>
            <li>
              <Link href={'/dashboard/projects'} className="text-sm">Preferences</Link>
            </li>
            <li>
              <Link href={'/dashboard/projects'} className="text-sm">Security</Link>
            </li>
          </ul>
        </div>
        <div className="px-6 py-5">
          <Link href={'/dashboard/projects'} className="text-sm">Log Out</Link>
        </div>
      </nav>
