...
export default function StatsItem({title, count, average}: {title: string, count: number, average: string}) {
  return (
    <div className="px-4 border-border md:border-r-2  border-b-2 md:border-b-0 last:border-r-0 last:border-b-0 py-4">
      ...
      <div className="flex justify-between items-center ">
        ...
        <div className="h-[30px] flex p-2 items-center bg-[#DCFCE6] rounded-full">
            ...
            <span className="text-sm pl-1 text-black">{100}%</span>
          </div>
      </div>
